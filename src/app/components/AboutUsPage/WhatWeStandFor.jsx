...
function WhatWeStandFor() {
  return (
    <section className="relative">
      ...
      <div className="max-w-[1440px] w-11/12 mx-auto flex flex-col lg:flex-row gap-32 items-center py-12 lg:py-28 relative">
        <Image
          src={"/icons/star1.png"}
          height={200}
          width={200}
        ...
        <div className="relative w-full">
          <Image
            ...
            width={800}
            alt="Mom Image"
            className="absolute top-0 left-0 h-[353px] w-[460px] object-cover mx-auto rounded-[45px] -ml-8 md:-ml-10 lg:-ml-16  -mt-4 md:-mt-6 lg:-mt-9 blur -z-10 "
          />
          <Image
            src={"/images/smily.jpg"}
            height={800}
            width={800}
            alt="Mom Image"
            className="h-[353px] w-[460px] object-cover mx-auto rounded-[45px]"
          />
        </div>
