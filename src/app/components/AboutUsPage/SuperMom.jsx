...
function SuperMom() {
  return (
    <section className="py-12 lg:py-20">
      <div className="max-w-[1440px] w-11/12 mx-auto flex flex-col md:flex-row gap-6 items-center">
        <div>
          <h1 className="text-[30px] md:text-4xl lg:text-[56px] font-bold font-lato mb-7 leading-normal">
            For Moms Who Do It All—<span className="text-primary">and Own  It</span>
          </h1>
        ...
        <div className="relative">
          <div className="h-[328px] w-[420px] rounded-[45px] bg-[#E6E6FA8F] flex items-center justify-center ">
