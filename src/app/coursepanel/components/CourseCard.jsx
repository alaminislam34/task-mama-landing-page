    ...
    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition duration-300 overflow-hidden border border-gray-100 transform hover:scale-[1.01] group">
      ...
      <div className="p-5">
        ...
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-3 cursor-pointer bg-primary text-white font-semibold rounded-lg shadow-md hover:bg-primary/90 transition duration-150 transform hover:scale-[1.02]"
